        ...
        describe('boombox', function(){
            ...
            it('addFilter()', function() {
                boombox.addFilter('chrome', function filter() {
                    ...
                    if (chrome) {
                        $("#info").append($('<h4 style="color: #DC143C;">Hit filter (chrome)</h4>'));
                        return false;
                    } else {
                        $("#info").append($('<h4 style="color: #008B8B;">No Hit filter (chrome)</h4>'));
                        return true;
                    }
                });

                //boombox.addFilter('FALSE', function filter() {
                //    return false;
                //});
                //boombox.addFilter('TRUE', function filter() {
                //    return true;
                //});
